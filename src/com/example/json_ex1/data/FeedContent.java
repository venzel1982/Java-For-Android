...
public class FeedContent {
	...
	/*
	 * создадим класс FeedItem как хранилище данных  
	 * при создании через конструктор загоним данные 
	 * */
...
//скажем что у нас есть масив хешей  
    	    ...
    	    public void run() {
    	        ...
    	        try {
    	          ...
    	          for (int i=0; i<posts.length(); i++)
    	          {
    	        	  ...
    	        	  JSONObject		contentObj = curPost.getJSONObject("content");
    	        	  String			content = contentObj.optString("$t");

    	        	  FeedItem			curFeedItem = new FeedItem(id, title, date, content);
    	        	  addItem(curFeedItem);
    	          }
    ...
    private static String readFeed() {
    	/*
    	 * пшлем запрос и получим ответ в зависимости от ответа добавляем построчно либопишем в лог о ошибке 
    	 * 
    	 * 
    	 * */
